  ...
  return (
    <section id="ask" className="relative text-white" style={{ backgroundColor: BG }}>
      <style jsx global>{`
        ...
        /* borda gradiente só no topo e base da caixa */
        #ask .card {
          position: relative;
          border-radius: 16px;
        ...
        #ask .card::before { top: 0; }
        #ask .card::after { bottom: 0; }

        /* só mobile usa gutter padrão; desktop não desloca a caixa */
        @media (min-width: 1181px) and (max-width: 1439px) {
          #ask .wrap { margin-left: 26px; }
        }
        @media (min-width: 1440px) {
          #ask .wrap { margin-left: 40px; }
        }
      `}</style>
      ...
      <div className="min-[820px]:hidden px-5 py-10">
        <div className="mx-auto max-w-[560px] text-center">
          <h2 className="font-serif text-[26px] leading-snug">
            Construindo uma <span className="italic font-semibold" style={{ color: HILIGHT }}>startup de IA</span> e em busca do
            primeiro cheque? Queremos muito te conhecer.
          </h2>
